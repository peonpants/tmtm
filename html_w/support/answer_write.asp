  ...
  <table border="0" width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse; color: white" class="board_view">
    ...
    <tbody>
        <tr>
          ...
          <td>
              <input name="BC_TITLE" type="text" maxlength="14" id="ctl00_ContentPlaceHolder1_txtTitle" style="color:White;background-color:Black;border-color:#4C4C4C;border-width:1px;border-style:Solid;height:30px;width:100%;box-sizing: border-box; padding: 0 10px">
          </td>
        </tr>
        <tr>
          <th align="center">
              문의내용</th>
          <td>
            <textarea name="BC_CONTENTS" rows="2" cols="20" id="ctl00_ContentPlaceHolder1_txtContent" onkeydown="return CheckStrLen(this,300)" style="color:White;background-color:Black;border-color:#4C4C4C;border-width:1px;border-style:Solid;height:276px;width:100%;box-sizing: border-box; padding: 10px"></textarea>
          </td>
        </tr>
    </tbody>
  </table>
