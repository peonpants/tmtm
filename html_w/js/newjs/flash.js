...
function ShowFlash(url, width, height, vars){
        ...
        document.write('<embed src="' + url + '" quality="high"  allowScriptAccess="sameDomain" allowFullScreen="false" type="application/x-shockwave-flash"  pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="' + width + '" height="' + height + '" ></embed>');
...
function Flash(id, iWith, iHeight, strFileUrl, bId,fmode,bgcolor) {
	...
	if (NaviType == "Netscape"){	
		...
		document.write("<embed src=\""+strFileUrl+"?"+fmode+"\" quality=\"high\" wmode=\"transparent\" width=\""+iWith+"\" height=\""+iHeight+"\" name=\""+bId+"\" id=\""+id+"\" align=\"middle\" allowScriptAccess=\"sameDomain\" type=\"application/x-shockwave-flash\" pluginspage=\"http://www.macromedia.com/go/getflashplayer\" />");
		document.write("</object>");
	}else{
		var str = "";	
		...
		str += "<embed src=\""+strFileUrl+"?"+fmode+"\" quality=\"high\" wmode=\"transparent\" pluginspage=\"http://www.macromedia.com/go/getflashplayer\" type=\"application/x-shockwave-flash\" width=\""+iWith+"\" height=\""+iHeight+"\" id=\""+id+"\"></embed>";
		str += "</object>";
		document.write(str);
	}
}
//var eCi = "210.112.2.34";
