...
function Calendar(obj) {														// jucke
	...
	// 두개의 textbox에 값을 넣을때
	if(target == pTarget) {  // 같은 textbox이면 none이면 block, block이면 none
		minical.style.display = (minical.style.display == "block") ? "none" : "block";
	} else {	// 다른 textbox이면 한개는 none, 한개는 block
...
function Show_cal(sYear, sMonth, sDay) {
	...
	Cal_HTML = "<TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0 ONMOUSEOVER=doOver(); ONMOUSEOUT=doOut(); STYLE='font-size:8pt;font-family:Tahoma;'>"
			+ "<TR ALIGN=CENTER><TD COLSPAN=7 nowrap=nowrap ALIGN=CENTER><SPAN TITLE='이전달' STYLE=cursor:hand; onClick='Show_cal("+intPrevYear+","+intPrevMonth+",1);'><FONT COLOR=#2992FF>◀</FONT></SPAN> "
			...
			+ " <SPAN TITLE='다음달' STYLE=cursor:hand; onClick='Show_cal("+intNextYear+","+intNextMonth+",1);'><FONT COLOR=#2992FF>▶</FONT></SPAN></TD></TR>"
	...
	Cal_HTML += "<TR><td colspan=\"7\" align=\"right\"><font size=\"1\">[<a href=\"javascript:doClose();\"><font color=\"#0B151B\">close</font></a>]</a></td></tr>";
	Cal_HTML += "</TABLE>";
