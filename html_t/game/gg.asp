...
<body>
    <div class="content">
		...
		<script type='text/javascript'> 
			jwplayer('playerMuLopKAGyXcB').setup({
				file: 'rtmp://vsports.bet365.com/live/L1_C146_S2_high',
				primary: 'flash',
				width: '872',
				height: '514',
				aspectratio: '16:9',
    ...
    <div style="text-align: center; height: 30px;">
        <a href="g.asp" class="">Premiership</a>
        <a href="gg.asp" class="active">Superleague</a>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if (!isPC()) {
                $('.content').html('<video x-webkit-airplay="deny" preload="auto" poster="http://" controls="controls" webkit-playsinline="" autoplay width="550" height="320" src="https://vmobile.bet365.com/C146_S1_o/smil:L1_C146_S1.smil/playlist.m3u8"></video>');
            }
        });
    </script>
</body>
